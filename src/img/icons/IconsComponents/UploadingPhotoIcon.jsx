import { Circle, Svg, Path, Rect, ClipPath, G, Defs } from "react-native-svg";

export default function uploadingPhotoIcon({ circleFill, cameraFill }) {
  return (
    <Svg width="60" height="60" viewBox="0 0 60 60" fill="none">
      <Circle cx="30" cy="30" r="30" fill={circleFill} />
